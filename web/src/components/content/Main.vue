<template>
  <div>
    <div class="tabbar bg-black py-2 px-4 d-flex ai-center">
      <img :src="require(`@/assets/img/logo.png`)" height="30" />
    ...
    <div class="bg-primary pt-3 pb-2">
      <div class="nav nav-inverse pb-1 jc-around">
        ...
        <div class="nav-item">
          <router-link class="nav-link" tag="div" to="/">IP游戏</router-link>
        </div>
      </div>
    </div>
